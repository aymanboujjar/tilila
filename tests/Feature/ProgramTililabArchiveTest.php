...
it('reuses tilila jury photos for matching tililab jury members', function () {
    ...
    Storage::disk('public')->put(
        'tilila-editions/jury/sample.jpg',
        'fake-image',
    );
...
it('prefers a tililab-specific jury photo when already set', function () {
    Storage::fake('public');
    Storage::disk('public')->put(
        'tililab-editions/jury/custom.jpg',
        'fake-image',
    );
    ...
    Storage::disk('public')->put(
        'tilila-editions/jury/tilila.jpg',
        'fake-image',
    );
...
it('replaces missing tililab jury photo paths with matching tilila photos', function () {
    Storage::fake('public');
    Storage::disk('public')->put(
        'tilila-editions/jury/sample.jpg',
        'fake-image',
    ...
    $edition = TililabEdition::query()->create([
        ...
        'jury' => [
            [
                'full_name' => 'Sanaa Akroud',
                'bio' => ['en' => 'Bio', 'fr' => 'Bio', 'ar' => 'Bio'],
                'photo_path' => 'tilila-editions/jury/sanaa_akroud.jpg',
            ],
        ],
        'sort' => 0,
        'is_current' => false,
