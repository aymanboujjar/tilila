/**
 * Wayfinder helpers (query strings, URL defaults). Kept in one module so
 * generated `routes/**` imports resolve without a barrel `export *` chain
 * that can break runtime binding of `queryParams` in some bundler orders.
 */
