...
const CARDS = [
    ...
    },
    {
        ...
        title: 'TILILAB',
        subtitleEn: "Reveal tomorrow's storytellers.",
        subtitleFr: 'Révéler les storyteller.euse.s de demain.',
        subtitleAr: 'اكتشاف صانعي وصانعات القصص البصرية في الغد.',
        bodyEn: 'Tililab aims to bring out new visual storytelling talent in line with 2M’s equity, diversity and inclusion values, with full professional support from idea to finished content.',
        bodyFr: 'Tililab a pour but de faire émerger les nouveaux talents de la narration visuelle en accord avec les valeurs d’équité, de diversité et d’inclusion portées par 2M, avec un accompagnement professionnel complet de l’idée au contenu fini.',
        bodyAr: 'يهدف تيليلاب إلى إبراز مواهب جديدة في السرد البصري وفق قيم المساواة والتنوع والإدماج التي تتبناها 2M، مع مرافقة مهنية كاملة من الفكرة إلى المحتوى النهائي.',
