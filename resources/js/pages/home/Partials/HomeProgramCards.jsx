...
const ProgramCard = memo(function ProgramCard({ card }) {
    ...
    return (
        <StaggerItem y={28}>
            <Link
                href={card.href}
                className="group relative block min-h-[260px] overflow-hidden rounded-2xl shadow-lg transition duration-200 hover:-translate-y-1 hover:shadow-xl sm:min-h-[300px]"
            >
                <div
                ...
                <div className="relative z-10 flex min-h-[260px] sm:min-h-[300px]">
                    <div className="flex flex-1 flex-col justify-center px-6 py-7 sm:px-8 sm:py-8">
                        <span className="inline-flex size-10 items-center justify-center rounded-full border border-twhite/35 bg-twhite/10 text-twhite transition group-hover:scale-105">
                            <Icon
                                className="size-5"
                                strokeWidth={1.75}
                                aria-hidden
